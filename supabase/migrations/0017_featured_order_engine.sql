-- ============================================================================
-- HypeKnight V3.5 - Featured Order Engine
-- ============================================================================
--
-- Converts a group of Featured inventory selections into one atomic
-- HypeKnight order.
--
-- One purchase:
--
...
-- with:
--
--   one event_order_item per Featured calendar date
--   one featured_reservations row per Featured calendar date
--
-- The entire operation occurs in one PostgreSQL transaction. If any selected
-- date is invalid or sold out, no partial Featured cart is created.
-- ============================================================================
