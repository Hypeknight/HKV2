-- ============================================================================
-- HypeKnight V3.5 - Featured Checkout Hold Buffer
-- ============================================================================
--
-- Stripe Checkout requires at least 30 minutes from Checkout Session creation.
-- Featured reservations are created before the Stripe session, so HypeKnight
-- uses a 35-minute hold to preserve a small session-creation buffer.
-- ============================================================================
...
begin
  ...
  -- ------------------------------------------------------------------------
  -- Create a 35-minute checkout hold.
  -- ------------------------------------------------------------------------

  v_expires_at := now() + interval '35 minutes';
