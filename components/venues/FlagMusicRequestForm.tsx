...
import { flagVenueMusicRequest } from '@/app/venues/actions';

export default function FlagMusicRequestForm({
  requestId,
  venueSlug,
}: {
  requestId: string;
  ...
  return (
    <details className="rounded-xl border border-white/10 bg-black/20 p-3 text-white">
      ...
      <form action={flagVenueMusicRequest} className="mt-3 space-y-3">
