    ...
    return (
      <section className="rounded-[2rem] border border-white/10 bg-white/5 p-6 sm:p-8">
        ...
        <p className="mt-3 text-sm leading-6 text-white/55">
          Future event transitions will appear here with the actor, source,
    ...
    <section className="rounded-[2rem] border border-white/10 bg-white/5 p-5 sm:rounded-[2.5rem] sm:p-8">
      <div>
        ...
        <p className="mt-3 max-w-3xl text-sm leading-6 text-white/55">
          A permanent operational record of event submissions, approvals,
          revisions, cancellations, removals, and automated changes.
        </p>
      </div>
            ...
            <div>
              ...
              <p className="mt-3 text-sm text-white/60">
                ...
                <span className="font-semibold text-white">
                  {formatActor(item.changed_by_role)}
                </span>
                {' · '}
